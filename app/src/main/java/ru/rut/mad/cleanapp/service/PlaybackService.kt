package ru.rut.mad.cleanapp.service
...
import ru.rut.mad.cleanapp.widget.MusicWidget
import ru.rut.mad.cleanapp.widget.MusicWidgetActions
import ru.rut.mad.cleanapp.widget.MusicWidgetState
...
class PlaybackService : MediaSessionService() {
    ...
    override fun onCreate() {
        ...
        // --- ДОБАВЛЕНО: Включаем бесконечный повтор всего списка ---
        ...
        val track1 = MediaItem.fromUri("android.resource://$packageName/${R.raw.track1}")
        val track2 = MediaItem.fromUri("android.resource://$packageName/${R.raw.track2}")
